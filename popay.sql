...
(255) NOT NULL COMMENT 'Bidang Studi Rekayasa/Tata Niaga',
  `program_studi` varchar
(255) NOT NULL COMMENT 'TKJ/Teknik Telekomunikasi/dll',
...
(11) NOT NULL,
  `bulan` enum
('januari','februari','maret','april','mei','juni','juli','agustus','september','oktober','november','desember') NOT NULL,
  `status_pembayaran` tinyint
(1) DEFAULT '0',
...
(255) NOT NULL,
  `level` varchar
(255) NOT NULL DEFAULT 'mahasiswa',
  `jenjang` enum
('D3','D4') NOT NULL,
  `prodi` varchar
(255) NOT NULL,
...
(20) NOT NULL,
  `tipe` varchar
(255) NOT NULL COMMENT 'tipe transaksi (UKT/donasi/dll)',
  `jenis` enum
...
(11) NOT NULL,
  `metode` varchar
(255) NOT NULL COMMENT 'metode pembayaran (QR Code/NIM)',
  `deskripsi` varchar
(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
