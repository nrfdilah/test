...
<body>
    ...
    <h1>
        Transfer <small class="text-muted"><?=$data["nim"]?></small>
    </h1>
        ...
        <div class="col-sm-6">
            <form action="transfer.php" method="get">
                <div class="form-group">
                    <label for="nim_transfer">NIM Tujuan</label>
                    <input type="number" class="form-control" name="nim" min="0" max="99999999999" value="" required>
                </div>
