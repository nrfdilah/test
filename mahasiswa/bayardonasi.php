                ...
                <div class="card-body">
                    ...
                    <form action="../aksi/bayar_donasi.php" method="post" class="mt-3" id="donasi-form">
                        <div class="form-group">
                            <label for="jumlah_donasi">Donasikan sedikit uangmu (<?= rupiah($mindonasi) ?> - <?= rupiah($maxdonasi) ?>)<br>
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control uang" name="jumlah_donasi" id="jumlah_donasi" step="100" value="<?= $mindonasi ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="table-wrapper-scroll-y table-scroll-v">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?= $d->private ? "-" : "$d->jenjang $d->prodi $d->kelas" ?></td>
    ...
    <script>
        $('#donasi-form').submit(function() {
            ...
            if (jd < <?= $mindonasi ?> || jd > <?= $maxdonasi ?>) {
                $("#jmess").text(`Jumlah donasi terlalu ${jd < <?= $mindonasi ?> ? "kecil" : "besar"}`);
                jumlahdonasi.focus();
                return false;
            }
