...
<body>
                ...
                <div class="col-sm-4 mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="ukt.php" class="btn btn-primary">Bayar</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body pt-0">
            ...
            <?php
                $semuaTagihan = $db->getUserUKTBill($data["id"], PDO::FETCH_OBJ);
            ?>
            ...
            <div class="row collapse" id="list-tagihan">
                ...
                if(!$semuaTagihan) {
                    ...
                    foreach($tagihan as $t) { 
                        if(bulanJurusanToNum($t->bulan) > bulanJurusanToNum(getBulan())) continue;
                ?>

                <div class="col-sm-4 mt-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">UKT Bulan <?=ucwords($t->bulan)?></h5>
                            <p class="card-text">
                                Kamu belum melakukan pembayaran UKT bulan <?=ucwords($t->bulan)?>    
                            </p>
                            ...
                            <div class="right-left">
                                ...
                                <div>
                                    <a href="ukt.php?focus=<?=$t->bulan?>" class="btn btn-primary">Bayar</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php include "../component/mahasiswa/riwayat.php" ?>
